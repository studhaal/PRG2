 ...
 * In dieser Klasse wird ein Bin�rbaum erzeugt und die Methode preorderPrint()
...
{
    /**
     * In dieser Methode wird ein Bin�rbaum erzeugt und Ihre Implementation
     * von preorderPrint() aufgerufen. 
     * Danach wird die korrekte Ausgabe angezeigt, so dass Sie einfach 
     * �berpr�fen k�nnen, ob Sie die Methode richtig implementiert haben.
     */
    ...
    // public w�ren, w�re der Aufbau des Baumes etwas intuitiver
    ...
    private static BinaryNode makeTree() 
    {
        ...
        /* 
         * Im Falle von public Attributen w�rde der Aufbau des Baumes
